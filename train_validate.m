function [avgcoef,seldeg,corrcoefs,maxE,minE,meanE,valR] = train_validate(Nt,print,TrainSet,ValSet)
...
%Load Test and Validation Data
 ...
 %%reading the file every iteration is bad, need to improve
